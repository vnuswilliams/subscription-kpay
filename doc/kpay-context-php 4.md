...
- Généré le : 2026-07-01T15:28:06.522Z
...
Valeurs live indisponibles au moment de la génération. Récupérez-les en direct :

```php
$ch = curl_init("https://admin.kpay.site/api/public/platform-info");
curl_setopt_array($ch, [
  CURLOPT_RETURNTRANSFER => true,
